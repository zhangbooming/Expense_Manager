...
render() {
    if(this.state.messageFromServer == ''){
      return (
        <div>
          <Button bsStyle="warning" bsSize="large" onClick={this.openModal}><span className="glyphicon glyphicon-edit"></span></Button>
          <Modal
...
<div className='button-center'>
              <br/>
              <Button bsStyle="warning" bsSize="large" onClick={this.onClick}>UPDATE</Button>
            </div>
          </Modal>
        </div>
      )
