...
render(){
  return (
    <Button bsStyle="danger" bsSize="large" onClick={this.onClick}>
     <Link to={{pathname: '/', search: '?month='+this.state.month+'&year='+this.state.year}} style={{ textDecoration: 'none', color:"#ffffff" }}>
